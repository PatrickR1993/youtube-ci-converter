...
def main():
    ...
    print("   python youtube_ci_converter.py --url https://youtu.be/VIDEO_ID")
    
    print("\n2. Process existing MP3 file:")
    print("   python youtube_ci_converter.py --file your_podcast.mp3")
    
    print("\n3. With custom output directory:")
    print("   python youtube_ci_converter.py --url https://youtu.be/VIDEO_ID --output /custom/path")
    
    print("\n4. With API key (if not set as environment variable):")
    print("   python youtube_ci_converter.py --url https://youtu.be/VIDEO_ID --openai-key YOUR_API_KEY")
    ...
    print(f"\n📁 Output files:")
    print("   - downloads/: Original MP3 files")
    print("   - output/: Bilingual audio + JSON transcripts")
